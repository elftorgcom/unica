...
try:
    ...
    if any(arg in ("-h", "--help") for arg in sys.argv[1:]):
        ...
        print("Missing Python dependency: lxml. Install with: python3 -m pip install lxml", file=sys.stderr)
        sys.exit(69)
...
def build_param_fragment(parsed, indent):
    ...
    if parsed.get("autoDates"):
        ...
        date_start_suffix = "\u0414\u0430\u0442\u0430\u041d\u0430\u0447\u0430\u043b\u0430"
        date_end_suffix = "\u0414\u0430\u0442\u0430\u041e\u043a\u043e\u043d\u0447\u0430\u043d\u0438\u044f"
        ...
        b_lines = [
            ...
            f"{i}\t<expression>{esc_xml('&' + param_name + '.' + date_start_suffix)}</expression>",
            f"{i}</parameter>",
        ]
        fragments.append("\r\n".join(b_lines))
        ...
        e_lines = [
            ...
            f'{i}\t<value xsi:type="xs:dateTime">0001-01-01T00:00:00</value>',
            f"{i}\t<useRestriction>true</useRestriction>",
            f"{i}\t<expression>{esc_xml('&' + param_name + '.' + date_end_suffix)}</expression>",
            f"{i}</parameter>",
        ]
        fragments.append("\r\n".join(e_lines))
