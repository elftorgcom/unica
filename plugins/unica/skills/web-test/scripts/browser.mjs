...
// Project root is the Codex working directory; override explicitly when needed.
const projectRoot = pathResolve(process.env.UNICA_PROJECT_ROOT || process.cwd());
 ...
 * Can be overridden via the explicit extensionPath option.
 */
