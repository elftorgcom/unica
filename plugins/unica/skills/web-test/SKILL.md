...
For recording, pass `ffmpegPath` explicitly or use `FFMPEG_PATH`. For narration, pass provider options explicitly or use provider environment variables such as `OPENAI_API_KEY`.
