...
```powershell
powershell.exe -NoProfile -File scripts/epf-validate.ps1 -ObjectPath "src/МойОтчёт"
powershell.exe -NoProfile -File scripts/epf-validate.ps1 -ObjectPath "src/МойОтчёт/МойОтчёт.xml"
```
